...
@class CLLocation; @class WCBizUtil; @class NewSettingViewController; @class FindFriendEntryViewController; @class ContactInfoViewController; @class CContactMgr; @class AutoSetRemarkMgr; @class CVerifyContactWrap; @class SayHelloDataLogic; @class FriendAsistSessionMgr; @class CContactVerifyLogic; @class BaseMsgContentViewController; @class MMTabBarController; @class MMTableViewCellInfo; @class MicroMessengerAppDelegate; @class ChatRoomInfoViewController; @class MMTableViewSectionInfo; @class CMessageWrap; @class MMNewSessionMgr; @class MMServiceCenter; @class WCRedEnvelopesLogicMgr; @class MMBadgeView; @class SettingUtil; @class CMessageMgr; @class AddContactToChatRoomViewController; 
