...
@class CContactVerifyLogic; @class NewSettingViewController; @class MicroMessengerAppDelegate; @class MMTableViewCellInfo; @class ContactInfoViewController; @class MMBadgeView; @class CMessageMgr; @class MMTabBarController; @class WCRedEnvelopesLogicMgr; @class CMessageWrap; @class AddContactToChatRoomViewController; @class SettingUtil; @class SayHelloDataLogic; @class FindFriendEntryViewController; @class CVerifyContactWrap; @class ChatRoomInfoViewController; @class CContactMgr; @class WCBizUtil; @class AutoSetRemarkMgr; @class MMNewSessionMgr; @class MMServiceCenter; @class CLLocation; @class MMTableViewSectionInfo; @class BaseMsgContentViewController; @class FriendAsistSessionMgr; 
...
#line 692 "/Users/admin/Documents/git/reverseWX/wx/wxDylib/wxDylib.xm"
