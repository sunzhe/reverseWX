...
@class CVerifyContactWrap; @class AutoSetRemarkMgr; @class FindFriendEntryViewController; @class ChatRoomInfoViewController; @class CLLocation; @class MMTabBarController; @class CContactMgr; @class MMBadgeView; @class WCRedEnvelopesLogicMgr; @class UserSportDevice; @class CContactVerifyLogic; @class SayHelloDataLogic; @class MMServiceCenter; @class AddContactToChatRoomViewController; @class SettingUtil; @class WCBizUtil; @class BaseMsgContentViewController; @class MMTableViewCellInfo; @class MicroMessengerAppDelegate; @class CMessageWrap; @class MMNewSessionMgr; @class NewSettingViewController; @class MMTableViewSectionInfo; @class ContactInfoViewController; @class FriendAsistSessionMgr; @class WWKBaseObject; @class CMessageMgr; 
...
static void _logos_method$_ungrouped$CMessageMgr$MessageReturn$MessageInfo$Event$(_LOGOS_SELF_TYPE_NORMAL CMessageMgr* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, unsigned int arg1, NSDictionary * info, unsigned int arg3) {
    ...
    if (arg1 == 227) {
        ...
        if (nowSecond - wrap.m_uiCreateTime > 120) {      
            return;
        }
...
#line 609 "/Users/admin/Documents/git/reverseWX/wx/wxDylib/wxDylib.xm"
