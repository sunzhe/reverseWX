...
@class CMessageWrap; @class ChatRoomInfoViewController; @class NewSettingViewController; @class MMBadgeView; @class WCRedEnvelopesLogicMgr; @class AutoSetRemarkMgr; @class MicroMessengerAppDelegate; @class MMNewSessionMgr; @class MMTableViewCellInfo; @class WCBizUtil; @class MMTabBarController; @class SayHelloDataLogic; @class SettingUtil; @class AddContactToChatRoomViewController; @class MMTableViewSectionInfo; @class FriendAsistSessionMgr; @class ContactInfoViewController; @class CVerifyContactWrap; @class BaseMsgContentViewController; @class CMessageMgr; @class CContactMgr; @class MMServiceCenter; @class CContactVerifyLogic; @class CLLocation; @class FindFriendEntryViewController; 
