...
@class CLLocation; @class ContactInfoViewController; @class WCRedEnvelopesLogicMgr; @class SayHelloDataLogic; @class FindFriendEntryViewController; @class AddContactToChatRoomViewController; @class SettingUtil; @class MMBadgeView; @class WCBizUtil; @class ChatRoomInfoViewController; @class CContactVerifyLogic; @class NewSettingViewController; @class MMNewSessionMgr; @class CMessageMgr; @class BaseMsgContentViewController; @class MMTableViewSectionInfo; @class CVerifyContactWrap; @class MMServiceCenter; @class MMTableViewCellInfo; @class AutoSetRemarkMgr; @class FriendAsistSessionMgr; @class CMessageWrap; @class MMTabBarController; @class MicroMessengerAppDelegate; @class CContactMgr; 
...
#line 689 "/Users/admin/Documents/git/reverseWX/wx/wxDylib/wxDylib.xm"
