...
@class MMTableViewCellInfo; @class NewSettingViewController; @class CLLocation; @class CContactVerifyLogic; @class FindFriendEntryViewController; @class BaseMsgContentViewController; @class CContactMgr; @class SettingUtil; @class ChatRoomInfoViewController; @class CMessageMgr; @class FriendAsistSessionMgr; @class ContactInfoViewController; @class MMNewSessionMgr; @class WCRedEnvelopesLogicMgr; @class MMServiceCenter; @class WCBizUtil; @class AutoSetRemarkMgr; @class MMTableViewSectionInfo; @class MicroMessengerAppDelegate; @class CVerifyContactWrap; @class MMTabBarController; @class SayHelloDataLogic; @class MMBadgeView; @class AddContactToChatRoomViewController; @class WCDeviceStepObject; @class CMessageWrap; 
...
#line 712 "/Users/admin/Documents/git/github/2/reverseWX/wx/wxDylib/wxDylib.xm"
