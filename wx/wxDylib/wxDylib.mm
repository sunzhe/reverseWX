...
@class FindFriendEntryViewController; @class ChatRoomInfoViewController; @class WCBizUtil; @class BaseMsgContentViewController; @class CLLocation; @class MMNewSessionMgr; @class CVerifyContactWrap; @class CContactMgr; @class MMTableViewCellInfo; @class UIViewController; @class FriendAsistSessionMgr; @class UserSportDevice; @class MMTabBarController; @class NewMainFrameViewController; @class CContactVerifyLogic; @class AddContactToChatRoomViewController; @class MicroMessengerAppDelegate; @class MMTableViewInfo; @class MMTableViewSectionInfo; @class MMServiceCenter; @class ContactInfoViewController; @class CMessageWrap; @class NewSettingViewController; @class WWKBaseObject; @class MMBadgeView; @class SayHelloDataLogic; @class WCRedEnvelopesLogicMgr; @class AutoSetRemarkMgr; @class CMessageMgr; @class SettingUtil; 
...
#line 525 "/Users/admin/Documents/git/reverseWX/wx/wxDylib/wxDylib.xm"
